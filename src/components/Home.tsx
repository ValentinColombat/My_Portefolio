...
const Home = () => {
    return (
        <div id="Home" className="relative py-20 md:py-32 flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute bottom-32 right-20 w-24 h-24 bg-gradient-to-br from-blue-500/15 to-transparent rounded-full floating-element-delayed"></div>
            <div className="absolute top-1/3 right-10 w-16 h-16 bg-gradient-to-br from-purple-500/20 to-transparent rounded-xl rotate-45 floating-element-slow"></div>
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
                    ...
                    <div className="space-y-8 md:order-1 order-2">
                        ...
                        <div className="space-y-4">
                            <h1 className="text-6xl md:text-7xl xl:text-8xl font-bold leading-none">
                                <span className="block text-white/40 text-2xl md:text-3xl font-normal mb-2 tracking-widest uppercase">
                                    Valentin Colombat
                                </span>
                        ...
                        <div className="flex gap-8 pt-4">
                            ...
                            <div className="text-center">
                                ...
                                <div className="text-sm text-white/50">Projets</div>
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-orange-400">100%</div>
                                <div className="text-sm text-white/50">Impliqué</div>
                            </div>
                        </div>
